...
void point(void) {
	...
	//retangulares de cores. Cada valor no vetor é mapeado para um ou mais pixels da tela. Um vetor de pixels de valores
	//de cor é denominado de pixmap. Outra forma de implementar um vetor de pixels é atribuir um bit 0 ou 1 
	//para cada elemento da matrix. 
	//
	GLubyte bitShape[28] = {
		0x1c, 0x00, 
		0x1c, 0x00, 
	...
	glBitmap(16, 18, 300.0, 100.0, 15.0, 15.0, bitShape);
